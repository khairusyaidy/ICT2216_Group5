...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['booking_id'])) {
    ...
    if ($stmt->execute()) {
        ...
        // Redirect to sdaycaredetail.php after successful update
        ...
        <div class="container px-4 px-lg-5 mt-3">
            ...
            if (isset($_GET['id'])) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    // Display edit form
                    echo '<form action="sdaycareedit.php" method="post">';
                    ...
                    echo '<a href="sdaycaredetail.php?id=' . htmlspecialchars($row['ID']) . '" class="btn btn-secondary ml-2">Cancel</a>';
                    echo '</form>';
                } else {
