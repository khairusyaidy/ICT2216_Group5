...
$sql = "SELECT b.ID, b.DropOffDate, b.PickUpDate, b.Food, b.Remarks, b.TotalPrice, b.ReviewID, s.ServiceName, p.Name AS PetName, p.Weight AS PetWeight
        FROM booking b
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <?php if (!isset($booking['ReviewID']) || is_null($booking['ReviewID'])): ?>
