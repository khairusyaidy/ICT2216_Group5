    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Availability Records
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    // Display action buttons based on Deleted_At status
                                    echo '<td>';
                                ...
                                echo '<tr><td colspan="10">No availability records found.</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
